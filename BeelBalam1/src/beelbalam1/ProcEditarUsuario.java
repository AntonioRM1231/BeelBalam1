...
public class ProcEditarUsuario {
    ...
    public void hacerConexionEditUsuario(){
        try {
            ...
            resConexionBU.setString(1,getNombreEU());
            resConexionBU.setString(2,getNewNombreEU());
            resConexionBU.setString(3,getNewContraseñaEU());
            resConexionBU.setString(4,getNewCorreoEU());
            resConexionBU.setString(5,getNewCelEU());
            resConexionBU.setString(6,getNewNumTarjetaEU());
            resConexionBU.setInt(7,getCvcEU());
            resConexionBU.setString(8,getNombreTEU());
            resConexionBU.setString(9,getSegNombreTEU());
            resConexionBU.setString(10,getPrimerApTEU());
            resConexionBU.setString(11,getSegundoApTEU());
            resConexionBU.setInt(12,getFechaVEU());
